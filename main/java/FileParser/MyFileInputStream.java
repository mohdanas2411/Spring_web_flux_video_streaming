...
public class MyFileInputStream {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String SOURCE_PATH = "/home/admin1/Downloads/springwebflux-video-streaming-main/src/main/java/FileParser/";

        String TARGET_PATH = "/home/admin1/Downloads/springwebflux-video-streaming-main/src/main/resources/streamVid/";
        String RAW_STREAM_FILE = "stream";

        String H264_STREAM_FILE = "streamVid1.H264";

        String OUTPUT_VID = "Output_Vid2.mp4";
        ...
        String[] cmd={"ffmpeg", "-i", SOURCE_PATH+H264_STREAM_FILE, "-c", "copy", TARGET_PATH+OUTPUT_VID};
